...
numLoops=1000; % The number of loops of each set of a given number of rounds (above)
...
% Compiles the mean lifetime payoff for each strategy over the number of
% loops
[tableMeanLifePay]=lifetimePayoff(results);
MLP(loop,2:4)= tableMeanLifePay;
...
meanLifetimePayoff=array2table(MLP);

meanLifetimePayoff.Properties.VariableNames = {'Loop' 'StrS1' 'StrS2' 'StrS3'};

filename3 = 'meanLifePay.xlsx';

writetable(meanLifetimePayoff, filename3, 'Sheet', 1, 'Range', 'A1')


filename4 = 'allResults.xlsx';

writetable(strategyResultsTbl, filename4, 'Sheet', 1, 'Range', 'A1:E1001')

writetable(meanLifetimePayoff, filename4, 'Sheet', 1, 'Range', 'G1:J1001')